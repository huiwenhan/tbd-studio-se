...
/**
 * Test class for the {@link CDH5130Distribution} distribution.
 *
 */
public class CDH5130DistributionTest {
    ...
    @Test
    public void testCDH5130Distribution() throws Exception {
        HadoopComponent distribution = new CDH5130Distribution();
        assertNotNull(distribution.getDistributionName());
        assertNotNull(distribution.getVersionName(null));
        assertEquals(CDH5130Distribution.DISTRIBUTION_NAME, distribution.getDistribution());
        assertEquals(CDH5130Distribution.VERSION, distribution.getVersion());
