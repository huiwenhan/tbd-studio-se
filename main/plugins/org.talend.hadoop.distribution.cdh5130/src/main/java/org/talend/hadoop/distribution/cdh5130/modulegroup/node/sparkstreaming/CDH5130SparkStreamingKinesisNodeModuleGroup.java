...
public class CDH5130SparkStreamingKinesisNodeModuleGroup {
    ...
    public static Set<DistributionModuleGroup> getModuleGroups(String distribution, String version) {
        ...
        DistributionModuleGroup dmgSpark22 = new DistributionModuleGroup(
                CDH5130Constant.SPARK2_KINESIS_MRREQUIRED_MODULE_GROUP.getModuleName(), true, new NestedComponentCondition(new MultiComponentCondition(
