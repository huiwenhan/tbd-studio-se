...
public class CDH5130SparkStreamingKafkaClientModuleGroup {
    ...
    public static Set<DistributionModuleGroup> getModuleGroups(String distribution, String version) {
        ...
        DistributionModuleGroup dmgSpark22 = new DistributionModuleGroup(
                CDH5130Constant.SPARK2_KAFKA_CLIENT_MRREQUIRED_MODULE_GROUP.getModuleName(), true, new NestedComponentCondition( new MultiComponentCondition(
