...
public class CDH5130PigOutputModuleGroup {
    ...
    public static Set<DistributionModuleGroup> getModuleGroups() {
        ...
        hs.add(new DistributionModuleGroup(CDH5130Constant.PIG_HCATALOG_MODULE_GROUP.getModuleName(), false, hcatStorerCondition));
        hs.add(new DistributionModuleGroup(CDH5130Constant.HBASE_MODULE_GROUP.getModuleName(), false, hbaseStorerCondition));
        hs.add(new DistributionModuleGroup(CDH5130Constant.PIG_HBASE_MODULE_GROUP.getModuleName(), false, hbaseStorerCondition));
        hs.add(new DistributionModuleGroup(CDH5130Constant.PIG_AVRO_MODULE_GROUP.getModuleName(), false, avroStorerCondition));
        hs.add(new DistributionModuleGroup(CDH5130Constant.PIG_RCFILE_MODULE_GROUP.getModuleName(), false, rcfileStorerCondition));
