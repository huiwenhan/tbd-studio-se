...
//
// ============================================================================
package org.talend.hadoop.distribution.cdh5130.modulegroup;
...
public class CDH5130PigModuleGroup {
    ...
    public static Set<DistributionModuleGroup> getModuleGroups() {
        ...
        hs.add(new DistributionModuleGroup(CDH5130Constant.PIG_MODULE_GROUP.getModuleName()));
        hs.add(new DistributionModuleGroup(CDH5130Constant.HDFS_MODULE_GROUP.getModuleName()));
        hs.add(new DistributionModuleGroup(CDH5130Constant.MAPREDUCE_MODULE_GROUP.getModuleName()));
        hs.add(new DistributionModuleGroup(CDH5130Constant.PIG_HCATALOG_MODULE_GROUP.getModuleName(), false, hcatLoaderCondition));
        hs.add(new DistributionModuleGroup(CDH5130Constant.HBASE_MODULE_GROUP.getModuleName(), false, hbaseLoaderCondition));
        hs.add(new DistributionModuleGroup(CDH5130Constant.PIG_HBASE_MODULE_GROUP.getModuleName(), false, hbaseLoaderCondition));
        hs.add(new DistributionModuleGroup(CDH5130Constant.PIG_PARQUET_MODULE_GROUP.getModuleName(), false, parquetLoaderCondition));
        hs.add(new DistributionModuleGroup(CDH5130Constant.PIG_AVRO_MODULE_GROUP.getModuleName(), false, avroLoaderCondition));
        hs.add(new DistributionModuleGroup(CDH5130Constant.PIG_RCFILE_MODULE_GROUP.getModuleName(), false, rcfileLoaderCondition));
        hs.add(new DistributionModuleGroup(CDH5130Constant.PIG_SEQUENCEFILE_MODULE_GROUP.getModuleName(), false,
                sequencefileLoaderCondition));
        hs.add(new DistributionModuleGroup(CDH5130Constant.PIG_S3_MODULE_GROUP.getModuleName(), false, s3condition));
