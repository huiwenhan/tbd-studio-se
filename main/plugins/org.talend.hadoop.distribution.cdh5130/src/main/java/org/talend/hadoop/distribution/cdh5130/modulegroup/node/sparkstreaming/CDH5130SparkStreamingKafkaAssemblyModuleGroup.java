...
public class CDH5130SparkStreamingKafkaAssemblyModuleGroup {
    ...
    public static Set<DistributionModuleGroup> getModuleGroups(String distribution, String version) {
        ...
        DistributionModuleGroup dmgSpark22 = new DistributionModuleGroup(
                CDH5130Constant.SPARK2_KAFKA_ASSEMBLY_MRREQUIRED_MODULE_GROUP.getModuleName(), true, new NestedComponentCondition(new MultiComponentCondition(
