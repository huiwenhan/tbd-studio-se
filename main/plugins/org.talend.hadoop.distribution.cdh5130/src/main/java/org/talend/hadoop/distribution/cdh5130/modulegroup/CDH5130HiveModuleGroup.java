...
public class CDH5130HiveModuleGroup {

    public static Set<DistributionModuleGroup> getModuleGroups() {
        Set<DistributionModuleGroup> hs = new HashSet<>();
        hs.add(new DistributionModuleGroup(CDH5130Constant.HIVE_MODULE_GROUP.getModuleName()));
        ...
        hs.add(new DistributionModuleGroup(CDH5130Constant.HIVE_HBASE_MODULE_GROUP.getModuleName(), false, hbaseLoaderCondition));
