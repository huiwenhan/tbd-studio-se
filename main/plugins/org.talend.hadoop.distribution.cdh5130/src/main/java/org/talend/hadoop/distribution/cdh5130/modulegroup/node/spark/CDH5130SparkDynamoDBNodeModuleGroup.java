...
//
// ============================================================================
package org.talend.hadoop.distribution.cdh5130.modulegroup.node.spark;
...
public class CDH5130SparkDynamoDBNodeModuleGroup {
    ...
    public static Set<DistributionModuleGroup> getModuleGroups(String distribution, String version, String condition) {
        return ModuleGroupsUtils.getModuleGroups(distribution, version, condition,
                CDH5130Constant.SPARK_DYNAMODB_MRREQUIRED_MODULE_GROUP.getModuleName(), true);
    }
}
